            ...
            <div className="bg-gradient-to-br from-[#FCEBE5] to-[#FADCD1] rounded-2xl p-8 shadow-sm border border-[#FADCD1] hover:scale-105 transition-transform flex flex-col justify-center items-center text-center">
              ...
              <button onClick={() => {
                if (user) {
                  ...
                  sessionStorage.setItem('intendedRoute', '/dashboard');
                  navigate('/auth');
                }
              }} className="mt-2 bg-[#D97757] hover:bg-[#C26243] text-white px-6 py-3 rounded-lg font-medium transition-colors">
                Start Now
              </button>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-6xl mx-auto px-4">
          <div className="bg-gradient-to-r from-serene-100 to-sage-100 rounded-2xl p-10 md:p-16 relative overflow-hidden shadow-xl text-center">
            ...
            }} className="bg-serene-900 hover:bg-serene-800 text-white font-medium px-8 py-4 rounded-lg text-lg shadow-lg transition-all inline-block relative z-10">
              Get Started
            </button>
          </div>
        </div>
