        ...
        <div className="bg-white rounded-2xl shadow-sm p-8 text-center border border-slate-100">
          ...
          {phase === 'complete' ? (
            ...
            <>
              ...
              <p className="text-slate-500 mb-12 text-sm">Follow the animation. Inhale, hold, and exhale slowly.</p>
              ...
              <button onClick={toggleExercise} className={`w-full max-w-sm mx-auto py-4 rounded-xl text-white font-medium text-lg transition-all shadow-sm block ${isActive ? 'bg-orange-500 hover:bg-orange-600' : 'bg-cyan-600 hover:bg-cyan-700'}`}>
